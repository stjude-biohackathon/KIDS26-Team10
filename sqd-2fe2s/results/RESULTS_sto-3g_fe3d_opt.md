...
Ansatz: LUCJ from frozen-core CCSD `t1`/`t2`, `n_reps=4`, `optimize=True`. Sampled on `ffsim` (global depolarizing 0.01), 100000 shots. Circuit depth 983, 1908 two-qubit gates.

| run | energy (Ha) | error vs CASCI | subspace dim | <S^2> |
|---|---|---|---|---|
| LUCJ ansatz expectation value (no SQD) | -5012.423076 | +1226.0 mHa | - | - |
...
- The LUCJ ansatz itself sits +1226.0 mHa above CASCI with a participation ratio of 3259.38; SQD's accuracy comes from the classical diagonalization, not from the ansatz energy.
...
![convergence](figures/convergence_sto-3g_fe3d_opt.png)

| samples/batch | subspace dim | % of CAS | E (Ha) | error (mHa) | ⟨S²⟩ |
|---|---|---|---|---|---|
| 20 | 24649 | 38.8% | -5013.29101183 | +358.0549 | 0.0628 |
| 50 | 48400 | 76.2% | -5013.50380547 | +145.2612 | 0.2561 |
| 100 | 59536 | 93.8% | -5013.61316743 | +35.8993 | 0.0706 |
| 200 | 63001 | 99.2% | -5013.64155618 | +7.5105 | 0.0140 |
| 400 | 63504 | 100.0% | -5013.64906670 | +0.0000 | 0.0000 |
| 800 | 63504 | 100.0% | -5013.64906670 | +0.0000 | 0.0000 |
...
![noise](figures/noise_sto-3g_fe3d_opt.png)

| depolarizing rate | valid shots (correct N and Sz) | unique bitstrings | subspace dim | error (mHa) | ⟨S²⟩ |
|---|---|---|---|---|---|
| 0 | 100.00% | 26428 | 63504 | +0.0000 | 0.0000 |
| 0.001 | 99.91% | 26511 | 63504 | +0.0000 | 0.0000 |
| 0.003 | 99.72% | 26678 | 63504 | +0.0000 | 0.0000 |
| 0.01 | 99.08% | 27251 | 63504 | +0.0000 | 0.0000 |
| 0.03 | 97.22% | 28943 | 63504 | +0.0000 | 0.0000 |
| 0.1 | 90.67% | 34808 | 63504 | +0.0000 | 0.0000 |

## Configuration-recovery convergence

![iterations](figures/iterations_sto-3g_fe3d_opt.png)

## Orbital occupancies

![occupancies](figures/occupancies_sto-3g_fe3d_opt.png)
